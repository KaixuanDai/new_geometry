var createScene = function () {
    ...
    tri1.position=new BABYLON.Vector3(6,1,1)
    tri1.scaling = new BABYLON.Vector3(4, 1, 4);
    tri1.rotation = new BABYLON.Vector3(-Math.PI/2, -Math.PI,0);
    tri1.state = "truetri1";
    ...
    tri2.position=new BABYLON.Vector3(0,3,0.8)
    tri2.scaling = new BABYLON.Vector3(2/1.4*2, 1, 2/1.4*2);
    tri2.addRotation(-Math.PI/2, 0, 0).addRotation(0,-Math.PI*3/4, 0);
    tri2.state = "truetri2";
    ...
    tri3.position=new BABYLON.Vector3(0.5,8.9,1)
    tri3.scaling = new BABYLON.Vector3(2*1.4*2, 1, 2*1.4*2);
    tri3.addRotation(Math.PI/2, 0, 0).addRotation(0,-Math.PI/4, 0);
    tri3.state = "truetri3";
    ...
    tri4.position=new BABYLON.Vector3(2,1,0.8)
    tri4.scaling = new BABYLON.Vector3(2*1.4*2, 1, 2*1.4*2);
    tri4.addRotation(-Math.PI/2, 0, 0).addRotation(0,-Math.PI/4, 0);
    tri4.state = "truetri4";
    ...
    tri5.position=new BABYLON.Vector3(0,3,0.8)
    tri5.scaling = new BABYLON.Vector3(2/1.4*2, 1, 2/1.4*2);
    tri5.addRotation(-Math.PI/2, 0, 0).addRotation(0,Math.PI*3/4, 0);
    tri5.state = "truetri5";
    ...
    box.position=new BABYLON.Vector3(1.7,7.7,0.8)
    box.scaling = new BABYLON.Vector3(1*2, 1, 1*2);
    box.addRotation(-Math.PI/2, 0, 0).addRotation(0,0, 0);
    box.state = "truebox";
    ...
    para.position=new BABYLON.Vector3(7.3,4.9,1)
    para.scaling = new BABYLON.Vector3(1*2, 1, 1*2);
    para.addRotation(Math.PI/2, 0, 0).addRotation(0,-Math.PI/4, 0);

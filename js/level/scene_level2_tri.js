var createScene = function () {
    ...
    true_tri1.position=new BABYLON.Vector3(1,1,1)
    ...
    true_tri2.position=new BABYLON.Vector3(5,1,1)
    ...
    // true_tri3.position=new BABYLON.Vector3(-3,1,1)
    ...
    var true_tri3 = BABYLON.MeshBuilder.ExtrudePolygon("truetri3",{shape:tri, depth: 0.2,sideOrientation: BABYLON.Mesh.DOUBLESIDE,updatable:true}, scene);
    true_tri3.material=blankMaterial;
    true_tri3.position=new BABYLON.Vector3(-3.1,1,1);
    true_tri3.scaling = new BABYLON.Vector3(2*1.4*2, 1, 2*1.4*2);
    ...
    true_tri4.position=new BABYLON.Vector3(5,1,1)
    ...
    true_tri5.rotation = new BABYLON.Vector3(0, Math.PI*3/4,0);
    ...
    true_box.position=new BABYLON.Vector3(1,1,5)
    true_box.scaling = new BABYLON.Vector3(1*2, 1, 1*2);
    true_box.rotation = new BABYLON.Vector3(0, Math.PI*3/4,0);
    ...
    true_para.position=new BABYLON.Vector3(1,1,-3)
...
/*********************************/
    ...
    tri1.position=new BABYLON.Vector3(-8,1,-7)
    ...
    tri2.position=new BABYLON.Vector3(15,1,-1)
    ...
    box.position=new BABYLON.Vector3(12,1,8)
    ...
    para.position=new BABYLON.Vector3(-1,1,-12)

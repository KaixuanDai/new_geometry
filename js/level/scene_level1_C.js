var createScene = function () {
    ...
    true_tri1.position = new BABYLON.Vector3(-2.9, 1, -0.5)
    ...
    true_tri2.position = new BABYLON.Vector3(5.4, 1, 2.15)
    ...
    true_tri4.position = new BABYLON.Vector3(-3, 1, 5)
    true_tri4.scaling = new BABYLON.Vector3(2 * 1.4 * 2, 1, 2 * 1.4 * 2);
    true_tri4.addRotation(0, Math.PI / 2, 0).addRotation(0, 0, 0);
    ...
    true_tri5.position = new BABYLON.Vector3(2.7, 1, -3.2)
    true_tri5.scaling = new BABYLON.Vector3(2 / 1.4 * 2, 1, 2 / 1.4 * 2);
    true_tri5.rotation = new BABYLON.Vector3(0, Math.PI, 0);
    ...
    true_para.position = new BABYLON.Vector3(5.4, 1, 5)
    ...
    tri2.position = new BABYLON.Vector3(15, 1, -3)
    ...
    tri4.position = new BABYLON.Vector3(10, 1, -6)
    tri4.scaling = new BABYLON.Vector3(2 * 1.4 * 2, 1, 2 * 1.4 * 2);
    tri4.addRotation(0, Math.PI / 2, 0).addRotation(0, 0, 0);
    tri4.state = "truetri4";
    ...
    tri5.rotation = new BABYLON.Vector3(0, Math.PI, 0);
    tri5.state = "truetri5";
    ...
    para.position = new BABYLON.Vector3(-1, 1, -9)

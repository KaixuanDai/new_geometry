var createScene = function () {
    ...
    true_tri1.position=new BABYLON.Vector3(3.8,1,-0.5)
    ...
    true_tri2.position=new BABYLON.Vector3(1,1,6.5)
    ...
    true_tri3.position=new BABYLON.Vector3(1,1,1)
    true_tri3.scaling = new BABYLON.Vector3(2*1.4*2, 1, 2*1.4*2);
    true_tri3.rotation = new BABYLON.Vector3(0,-Math.PI/2,0);
    ...
    true_tri4.addRotation(0, Math.PI, 0).addRotation(0,0,0);
    ...
    true_tri5.position=new BABYLON.Vector3(1,1,-4.5)
    ...
    true_box.position=new BABYLON.Vector3(1,1,-0.5)
    ...
    true_para.position=new BABYLON.Vector3(6.5,0.8,5)
    true_para.scaling = new BABYLON.Vector3(1*2,1,1*2);
    true_para.addRotation( Math.PI, 0, 0).addRotation(0, Math.PI/4,0);
    ...
    tri1.position=new BABYLON.Vector3(-13,1,-8)
    ...
    tri2.position=new BABYLON.Vector3(13,1,-2)
    ...
    tri3.position=new BABYLON.Vector3(-8,1,4)
    tri3.scaling = new BABYLON.Vector3(2*1.4*2, 1, 2*1.4*2);
    tri3.rotation = new BABYLON.Vector3(0,-Math.PI/2,0);
    tri3.state = "truetri3";
    ...
    tri4.position=new BABYLON.Vector3(2,1,-7)
    tri4.scaling = new BABYLON.Vector3(2*1.4*2, 1, 2*1.4*2);
    tri4.addRotation(0, Math.PI, 0).addRotation(0,0,0);
    tri4.state = "truetri4";
    ...
    para.position=new BABYLON.Vector3(10,0.8,-6)
    para.scaling = new BABYLON.Vector3(1*2, 1, 1*2);
    para.addRotation( Math.PI, 0, 0).addRotation(0, Math.PI/4,0);

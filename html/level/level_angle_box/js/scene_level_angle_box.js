var createScene = function () {
    ...
    true_box.position = new BABYLON.Vector3(0.4, 0.1, -13.3)
    true_box.scaling = new BABYLON.Vector3(1 * 8, 1, 1 * 8);
    ...
    var music = new BABYLON.Sound("music", "/audio/angle_box_begin.mp3", scene, null, { loop: false, autoplay: true, spatialSound: true });

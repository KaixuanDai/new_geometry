var createScene = function () {
    ...
    var true_box_top = BABYLON.MeshBuilder.ExtrudePolygon("truebox", { shape: box, depth: 0.2, sideOrientation: BABYLON.Mesh.DOUBLESIDE, updatable: true }, scene);
    ...
    true_box_top.state = "truebox";
    true_box_top.enableEdgesRendering();
    true_box_top.edgesWidth = 20.0;
    true_box_top.edgesColor = new BABYLON.Color4(0, 0, 1, 0.5);


    var true_box_bottom = BABYLON.MeshBuilder.ExtrudePolygon("truebox", { shape: box, depth: 0.2, sideOrientation: BABYLON.Mesh.DOUBLESIDE, updatable: true }, scene);
    ...
    true_box_bottom.state = "truebox";
    true_box_bottom.enableEdgesRendering();
    true_box_bottom.edgesWidth = 20.0;
    true_box_bottom.edgesColor = new BABYLON.Color4(1, 0, 0, 1);


    var true_box_left = BABYLON.MeshBuilder.ExtrudePolygon("truebox", { shape: box, depth: 0.2, sideOrientation: BABYLON.Mesh.DOUBLESIDE, updatable: true }, scene);
    ...
    true_box_left.rotation = new BABYLON.Vector3(0, Math.PI / 2, 0);
    true_box_left.state = "truebox";
    true_box_left.enableEdgesRendering();
    true_box_left.edgesWidth = 20.0;
    true_box_left.edgesColor = new BABYLON.Color4(0, 1, 0, 1);

    var true_box_right = BABYLON.MeshBuilder.ExtrudePolygon("truebox", { shape: box, depth: 0.2, sideOrientation: BABYLON.Mesh.DOUBLESIDE, updatable: true }, scene);
    ...
    true_box_right.rotation = new BABYLON.Vector3(0, Math.PI / 2, 0);
    true_box_right.state = "truebox";
    ...
    // tri1.position = new BABYLON.Vector3(-15, 1, -8)
    ...
    // tri3.position = new BABYLON.Vector3(-15, 1, 5)
    ...
    // tri4.position = new BABYLON.Vector3(-3, 1, -12)
    ...
    // para.position = new BABYLON.Vector3(8, 1, -6)

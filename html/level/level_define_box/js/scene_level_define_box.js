...
var createScene = function () {
    ...
    backgroundTexture.drawText("四条边都相等", null, 100, " 50px Segoe UI", "black", "white");
    backgroundTexture.drawText("四个角是直角", null, 200, " 50px Segoe UI", "black", null);
    backgroundTexture.drawText("两对边互相平行", null, 300, " 50px Segoe UI", "black", null);
    ...
    var music = new BABYLON.Sound("music", "/../audio/define_box.mp3", scene, null, { loop: false, autoplay: true, spatialSound: true });

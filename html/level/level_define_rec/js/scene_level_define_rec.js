...
var createScene = function () {
    ...
    backgroundTexture.drawText("两组对边分别相等", null, 100, " 50px Segoe UI", "black", "white");
    backgroundTexture.drawText("两组对边分别平行", null, 200, " 50px Segoe UI", "black", null);
    backgroundTexture.drawText("四个角都是直角", null, 300, " 50px Segoe UI", "black", null);
    ...
    var music = new BABYLON.Sound("music", "/../audio/define_rec.mp3",scene, null, { loop: false, autoplay: true, spatialSound: true });

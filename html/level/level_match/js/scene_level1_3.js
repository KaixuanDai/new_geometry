var createScene = function () {
    ...
    //创建地面
    var ground = BABYLON.Mesh.CreateGround("ground1", 40, 30, 2, scene);
    ...
    //正确位置的形状
    var true_tri1 = BABYLON.MeshBuilder.ExtrudePolygon("true_tri1",{shape:tri, depth: 0.2,sideOrientation: BABYLON.Mesh.DOUBLESIDE,updatable:true}, scene);
    ...
    var true_tri2 = BABYLON.MeshBuilder.ExtrudePolygon("true_tri2",{shape:tri, depth: 0.2,sideOrientation: BABYLON.Mesh.DOUBLESIDE,updatable:true}, scene);
    ...
    var true_tri3 = BABYLON.MeshBuilder.ExtrudePolygon("true_tri3",{shape:tri, depth: 0.2,sideOrientation: BABYLON.Mesh.DOUBLESIDE,updatable:true}, scene);
    ...
    var true_tri4 = BABYLON.MeshBuilder.ExtrudePolygon("true_tri4",{shape:tri, depth: 0.2,sideOrientation: BABYLON.Mesh.DOUBLESIDE,updatable:true}, scene);
    ...
    var true_tri5 = BABYLON.MeshBuilder.ExtrudePolygon("true_tri5",{shape:tri, depth: 0.2,sideOrientation: BABYLON.Mesh.DOUBLESIDE,updatable:true}, scene);
